...
const SOCIALS = [
  { icon: Mail, label: "Email", href: "mailto:mdmahdihasanriyad@gmail.com" },
  {
    icon: Facebook,
    label: "Facebook",
    href: "https://www.facebook.com/share/1ELc79F82H/",
  },
  {
    icon: Youtube,
    label: "YouTube",
    href: "https://youtube.com/@MahdiHandwritingbd",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/md-mahdi-hasan-riyad-1034a8204?utm_source=share_via&utm_content=profile&utm_medium=member_android",
  },
  {
    icon: MessageCircle,
    label: "WhatsApp",
    href: "https://wa.me/8801993479343",
  },
  ...
  { icon: XIcon, label: "X", href: "#" },
  {
    icon: TikTokIcon,
    label: "TikTok",
    href: "https://www.tiktok.com/@mahdihandwriting99?_r=1&_t=ZS-98F9e1BUubH",
  },
];
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-24 py-24">
        <div className="text-center mb-24 max-w-2xl mx-auto">
          ...
          >
            Looking to improve your handwriting, collaborate on a project, or
            invite me for a workshop? I'd love to hear from you.
          </motion.p>
        ...
        <div className="flex flex-col items-center justify-center gap-2 mb-8 pt-8 border-t border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-2 text-gray-500 text-sm font-medium">
            ...
            <span className="text-center">
              D Block, Aftabnagar Residential Area, Rampura, Dhaka-1212,
              Bangladesh
            </span>
          </div>
        </div>
