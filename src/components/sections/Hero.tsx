        ...
        <div className="flex flex-col items-center text-center space-y-8 relative z-10 max-w-5xl mx-auto">
          ...
          >
            <h1 className="font-display text-4xl md:text-6xl font-bold tracking-tight text-gray-900 dark:text-white leading-[1.1] mb-6">
              Learn Beautiful <br className="hidden md:block" />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand to-emerald-400">HANDWRITING.</span>
            </h1>
            <p className="font-medium text-xl md:text-2xl text-gray-900 dark:text-gray-200">
              Write Better. Think Better. Grow Better.
            </p>
          </motion.div>
          ...
          >
            <span className="flex items-center gap-2"><span className="text-brand text-lg">✓</span> Improve Handwriting</span>
            <span className="flex items-center gap-2"><span className="text-brand text-lg">✓</span> Boost Confidence</span>
            <span className="flex items-center gap-2"><span className="text-brand text-lg">✓</span> Better Presentation</span>
            <span className="flex items-center gap-2"><span className="text-brand text-lg">✓</span> Bright Future</span>
          </motion.div>
          ...
          >
            ...
            >
              Practice Materials <ArrowRight size={18} />
            </a>
          </motion.div>
          ...
          >
             <div className="flex flex-wrap justify-center gap-4 text-sm font-bold text-gray-500 uppercase tracking-wider">
               <span>Bangla</span> • <span>English</span> • <span>Arabic</span> • <span>Swift & Cursive</span>
             </div>
